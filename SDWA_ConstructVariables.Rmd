...
#setwd("/Users/elizabeth/Documents/Capstone Paper/Geography Data")
#files <- list.files(pattern="*.csv")

#Geography_Data <- rbindlist(lapply(files, fread))

# Remove duplicate rows (I don't think the EPA did this, I think I might have just downloaded some data points multiple times)
#Geography_Data <- Geography_Data[!duplicated(Geography_Data)]
...
Data$NumViolators_NumFacilities[which(Data$NumViolators_NumFacilities == Inf)] <- 0
Data$NumViolators_NumFacilities[is.na(Data$NumViolators_NumFacilities)] <- 0
```
